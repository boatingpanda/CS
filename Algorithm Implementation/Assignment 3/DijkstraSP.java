 ...
 *  ...
 *  Worse case runtime: E*log(V) where E is # of edges and V is number of vertices
 *  Space requirement: V
 *
 *************************************************************************/
...
public class DijkstraSP {
    ...
    // the only difference between Dijkstra and Lazy is this method
    private void relax(DirectedEdge e) {
        int v = e.from(), w = e.to();
        // if the distance to new vertex is greater than the current distance + edge weight
